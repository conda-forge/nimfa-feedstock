...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nimfa-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11773&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nimfa-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nimfa` can be installed with:

```
conda install nimfa
```

It is possible to list all of the versions of `nimfa` available on your platform with:
